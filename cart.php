                    ...
                    <nav id="navigation">
                        <ul id="main-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <?php
                                    $res = $con->query("Select distinct prod_id from cart");
            ...
            <div class="container">
                ...
                <DIV><h2>OUR PRODUCTS</h2>
                    <div style="padding-left:90%; margin-top:-42PX"> <label class="switch switch-flat">
                            <input class="switch-input" type="checkbox" onclick="demoprod.php"/>
                            ...
                            <div class="product-grid love-grid">
                                ...
                                <div class="product-info simpleCart_shelfItem">
                                    <div class="product-info-cust prt_name">
                                        ...
                                        <br/>
                                        <a href="cart.php?prod_id<?php echo $row["prod_id"]; ?>">
