        ...
        <div class="product-model">	 
            <div class="container">
                ...
                <script>
                    ...
                    {
                        var ech;
                        if ($('#sin_blk').attr('checked'))
                        {
                            var btns = document.getElementsByName('ordernow');
                            for (ech in btns)
                            {
                                btns[ech].value = "Add to Cart";
                            }
                        } else
                        {
                            var btns = document.getElementsByName('ordernow');
                    ...
                    function WorkOnIt()
                    {
                        ...
                        {
                            window.location = "contact.php?id=" + arguments[0];
                ...
                <DIV><h2>OUR PRODUCTS</h2>
                    <div style="padding-left:90%; margin-top:-42PX"> <label class="switch switch-flat">
                            <input class="switch-input" type="checkbox" id="sin_blk" onchange="fadeToggle()"/>
                            <span class="switch-label" data-on="BULK ORDER" data-off="SINGLE"></span> 
                    ...
                    while ($row = $res->fetch_assoc()) {
                        ...
                        <div class="product-info simpleCart_shelfItem">
                            <div class="product-info-cust prt_name">
                                <h4><?php echo $row["prod_name"]; ?>
                                    <!--<i class="icon-heart-empty fa-lg" onclick="wishaction()"  style="color:#0ca4ad;margin-left: 30px;"></i>-->
...
<!--                                    <select>
                                        <?php for ($i = 1; $i <= 100; $i++) { ?><option><?php echo $i; ?></option><?php } ?>
                                    </select>-->
                                </div> 
                                <br/>
                                <input type="submit" name="ordernow" id="<?php echo $row["prod_id"]; ?>" class="item_add items" value="Order Now" onclick="WorkOnIt('<?php echo $row["prod_id"]; ?>')"/>                                                                     
                                <input type="submit" name="ordernow" id="<?php echo $row["prod_id"]; ?>" class="item_add items" value="Add To Cart" onclick="WorkOnIt('<?php echo $row["prod_id"]; ?>')"/>
                            </div>													
                            <div class="clearfix"> </div>
                        </div>
                    </div>
